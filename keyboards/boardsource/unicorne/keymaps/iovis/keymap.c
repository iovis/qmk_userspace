...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //`--------+--------+---------+--------+---------+--------/   \--------+---------+--------+---------+--------+--------'
                                   KC_LALT, MO(1)   , KC_ENT  ,     MO(2)  , KC_SPC  , KC_RGUI
    //                           `+--------+---------+--------'   `--------+---------+--------+'
    ),
    ...
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                                  _______, _______, _______,     TT(3)  , _______, _______
    //                          `+--------+--------+--------'   `--------+---------+--------+'
    ),
    ...
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                                  _______, TT(3)  , _______,     _______, _______, KC_CAPS
    //                          `+--------+--------+--------'   `--------+--------+--------+'
    ),

    [_NUMPAD] = LAYOUT_split_3x6_3(
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
       KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, QK_BOOT,     _______, KC_7   , KC_8   , KC_9   , KC_ASTR, _______,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       KC_VOLD, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,     KC_PLUS, KC_4   , KC_5   , KC_6   , KC_EQL , KC_ENT ,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       KC_MUTE, _______, _______, _______, _______, _______,     KC_MINS, KC_1   , KC_2   , KC_3   , KC_SLSH, _______,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
