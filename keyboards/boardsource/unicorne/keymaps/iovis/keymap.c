...
uint32_t get_smtd_timeout(uint16_t keycode, smtd_timeout timeout) {
    ...
    if (timeout == SMTD_TIMEOUT_RELEASE) {
        if (keycode == SY_M) return 15;
        if (keycode == SY_V) return 15;
        if (keycode == NU_G) return 15;
    }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
       KC_ESC , KC_HASH, KC_LCBR, KC_RCBR, KC_DLR , KC_AT  ,     KC_CIRC, KC_AMPR, KC_LBRC, KC_RBRC, KC_PIPE, KC_BSLS,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
    ...
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, _______,     KC_MINS, KC_4   , KC_5   , KC_6   , KC_COLN, KC_EQL ,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       _______, KC_LCTL, KC_LALT, KC_LGUI, KC_UNDS, XXXXXXX,     KC_HASH, KC_1   , KC_2   , KC_3   , KC_SLSH, KC_PERC,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                                  _______, KC_COMM, MY_MEH ,     KC_SPC , KC_0   , KC_DOT
    //                          `+--------+--------+--------'   `--------+--------+--------+'
    ),
