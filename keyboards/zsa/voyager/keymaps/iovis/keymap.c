...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_SYM] = LAYOUT_voyager(
    ...
    _______, KC_GRV , KC_LABK, KC_RABK, KC_DLR , KC_PERC,                       KC_PERC, KC_AMPR, KC_ASTR, KC_PIPE, KC_EQL , KC_UNDS,
    _______, KC_EXLM, KC_MINS, KC_PLUS, KC_EQL , KC_SLSH,                       KC_DQUO, KC_LCBR, KC_LPRN, KC_RPRN, KC_SCLN, KC_COLN,
    _______, KC_TILD, KC_BSLS, KC_AT  , KC_SLSH, KC_CIRC,                       KC_QUES, KC_RCBR, KC_LBRC, KC_RBRC, KC_HASH, KC_ENT ,
                                                 _______, KC_0   ,     MY_CODE, _______
  ),

  [LAYER_NAV] = LAYOUT_voyager(
    _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                       KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,
    _______, KC_MPRV, KC_MPLY, KC_MNXT, RGB_VAD, RGB_TOG,                       XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, KC_F12 ,
  ...
  [LAYER_NUM] = LAYOUT_voyager(
    ...
    _______, _______, _______, _______, _______, _______,                       KC_SLSH, KC_7   , KC_8   , KC_9   , KC_EQL , QK_LLCK,
    _______, _______, _______, _______, _______, _______,                       KC_ASTR, KC_4   , KC_5   , KC_6   , KC_PLUS, KC_COLN,
